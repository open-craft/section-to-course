...
"""
section-to-course documentation build configuration file.
...
project = 'section-to-course'
project_title = 'section-to-course'
...
#
html_theme_options = {
    "repository_url": "https://github.com/open-craft/section-to-course",
...
#
# html_title = 'section-to-course v0.1.0'
...
man_pages = [
    (top_level_doc, project_title, documentation_title, 1)
]
...
texinfo_documents = [
    (top_level_doc, project_title, documentation_title, project_title,
...
def on_init(app):  # pylint: disable=unused-argument
    ...
    check_call([apidoc_path, '-o', docs_path, os.path.join(root_path, 'section_to_course'),
                os.path.join(root_path, 'section_to_course/migrations')])
